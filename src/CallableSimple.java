...
public class CallableSimple implements Callable<String> {
	/*
	...
	public String call() throws Exception {
		System.out.println("This will print execute() call cause execute() method dont have return type ");
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		 ...
		 */
		Future<String> future = service.submit(new CallableSimple());
...
class Task implements Runnable {
	...
	@Override
	public void run() {
		System.out.println("Hi It will execute by while call execute() cause no return type");
	}
